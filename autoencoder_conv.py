#mple of VAE on MNIST dataset using CNN
...
help_ = "Use custom training data (need to configure testing data as well)"
parser.add_argument("-tr", "--train", help=help_)
help_ = "Use custom testing data (need to configure training data as well)"
...
elif args.train is not None or args.test is not None:
    raise Exception("Must define both train and test variables, or neither")
data = (x_test, y_test)
